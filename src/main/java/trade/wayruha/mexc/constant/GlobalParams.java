...
public class GlobalParams {
     ...
     */
    public static final long DEFAULT_CONNECTION_TIMEOUT_MS = 5 * 1000;
    public static final long DEFAULT_CONNECTION_TTL_MS = 10 * 1000;
    ...
    public static int WEB_SOCKET_RECONNECT_ATTEMPT_NUMBER = 50;
}
